 ...
 * @returns {Promise}
 */
export function get(relativeUrl: any, param: any, header: any) {
 ...
 * post 方法
 */
export function post(relativeUrl: any, param?: any, header?: any) {
 ...
 * del 方法
 */
export function del(relativeUrl: any, param?: any, header?: any) {
 ...
 */
export function requestWithModal(method: string, relativeUrl: any, param: any, header: any) {
  return request(method, relativeUrl, param, header).catch(
    (res: { data: { message: any }; statusCode: any; errMsg: any }) => {
      let errMsg;
...
export function request(
  ...
  let response: string | ArrayBuffer | AnyObject;
  let error: UniApp.GeneralCallbackResult;
